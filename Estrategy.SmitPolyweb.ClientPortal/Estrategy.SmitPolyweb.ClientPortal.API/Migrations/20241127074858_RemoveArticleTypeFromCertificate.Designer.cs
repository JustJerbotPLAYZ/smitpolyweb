...
namespace Estrategy.SmitPolyweb.ClientPortal.API.Migrations
{
    ...
    [Migration("20241127074858_RemoveArticleTypeFromCertificate")]
    partial class RemoveArticleTypeFromCertificate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Estrategy.SmitPolyweb.ClientPortal.API.Models.Coupling.CertificateTicket", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Estrategy.SmitPolyweb.ClientPortal.API.Models.Coupling.CertificateTicket", b =>
                {
                    ...
                    b.HasOne("Estrategy.SmitPolyweb.ClientPortal.API.Models.Domain.Ticket", "Ticket")
                        .WithMany()
            ...
            modelBuilder.Entity("Estrategy.SmitPolyweb.ClientPortal.API.Models.Domain.Certificate", b =>
                {
                    ...
                    b.HasOne("Estrategy.SmitPolyweb.ClientPortal.API.Models.Domain.Address", "CustomerAddress")
                        .WithMany()
                    ...
                    b.HasOne("Estrategy.SmitPolyweb.ClientPortal.API.Models.Domain.Address", "SupplierAddress")
                        .WithMany()
            ...
            modelBuilder.Entity("Estrategy.SmitPolyweb.ClientPortal.API.Models.Domain.PasswordHistory", b =>
                {
                    b.HasOne("Estrategy.SmitPolyweb.ClientPortal.API.Models.Domain.User", "User")
                        .WithMany("previouslyUsedPasswords")
            ...
            modelBuilder.Entity("Estrategy.SmitPolyweb.ClientPortal.API.Models.Domain.User", b =>
                {
                    b.Navigation("previouslyUsedPasswords");
                });
