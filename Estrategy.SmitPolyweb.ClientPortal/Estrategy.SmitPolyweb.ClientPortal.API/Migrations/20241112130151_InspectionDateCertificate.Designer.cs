...
namespace Estrategy.SmitPolyweb.ClientPortal.API.Migrations
{
    ...
    [Migration("20241112130151_InspectionDateCertificate")]
    partial class InspectionDateCertificate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Estrategy.SmitPolyweb.ClientPortal.API.Models.Coupling.CertificateProperties", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Estrategy.SmitPolyweb.ClientPortal.API.Models.Domain.Property", b =>
                {
                    b.HasOne("Estrategy.SmitPolyweb.ClientPortal.API.Models.Domain.ArticleType", null)
                        .WithMany("Properties")
                        .HasForeignKey("ArticleTypeID");
